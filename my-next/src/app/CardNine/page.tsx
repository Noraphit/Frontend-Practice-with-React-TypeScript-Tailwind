    ...
    <>
      ...
      <div className="">
        <div className="p-[40px] h-[45vh] flex flex-row justify-center items-end">
          <p className="font-[500] text-[72px] w-[980px] leading-[85px] text-center">A minimal interface for a Swedish sunglasses brand</p>
        </div>

        <div className="flex justify-center gap-2">
          <div className="px-3 py-[6px] bg-[#e8e5e480] rounded-[19px]">
            <p className="text-[14px] font-[400]">Monokel Eyewear</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-[15px] container pt-[50px] mx-auto">
        ...
        <div className="px-[255px] relative py-10">
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-[1fr_1fr_1fr_1fr]">
              <p className="text-[#000000] text-[14px] font-[400]">Monokel Eyewear</p>
        ...
        <div className="px-[255px] relative py-10">
          ...
          <p className="w-[540px] text-[14px] font-[400]">I crafted a series of user interfaces for Monokel's ecommerce platform.
            I also art directed a range of imagery inspired by Monokel's Scandinavian heritage.</p>
        </div>
