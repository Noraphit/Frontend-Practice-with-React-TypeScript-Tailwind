    ...
    <>
      ...
      <div className="p-[15px] container pt-[50px] mx-auto">
        ...
        <div className="px-[255px] relative py-10">
          ...
          <p className="w-[540px] text-[14px] font-[400]">Working alongside Schuh’s internal design team and A_TK, I was responsible for designing the entire look and feel
